...
// ];
// const numberGreet = ("The friend number..");
// // const numberOfFriends = friends.length;
// const placeOfLiving = friends.map(function(friend) {

// return numberGreet + friends.length `${friend.first_name} lives in ${friend.location} `;
