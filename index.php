 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no"/>
  ...
  <script type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.min.js"
   ...
   <body>
         ...
         <div class="popup" data-popup="popup-1">
          <div class="popup-inner">
            ...
            <div class="tab" ><p>1)What gender are you?</p>
              ...
              <input type="radio" class="" name="" value="none" style="display:none;" checked/>
              <input type="radio" class="radios" name="gender" value="male"/>Male
                   <br>
              <input type="radio" class="radios" name="gender" value="female"/>Female
                   <br>
            ...
            <div class="tab"><p>6)How many foreign languages do you speak?</p>
              ...
              <input type="radio" class="radios" name="others" value="I'm a polyglot">I'm a polyglot<br>
    ...
    var currentTab = 0; // Current tab as the first tab (0)
...
// Survey JQuery plus Ajax
    ...
    var formData = $("#survey :input").serializeArray();
        formData[formData.length] = { name: "action", value: "nextBtn"};
        formData.push({});
     ...
     y = x[currentTab].getElementsByClassName("radios");
               ...
               <form id="contact" method="post" action="actions.php">
                ...
                <label for="message">Message*<span id="messageSpan"></span></label>
                 <textarea id="ymessage" name="message" placeholder="Write your message here!" style="height:170px"></textarea>
                  <button id="submit_contact" name="submitcontact">Submit</button>
               </form>
             </div>
             </div>
             </div>
