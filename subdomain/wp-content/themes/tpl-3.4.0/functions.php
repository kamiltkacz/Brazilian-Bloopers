...
genesis_register_sidebar( array(
	'id'		=> 'top-bar-left',
	'name'		=> __( 'Top Bar Left', 'tpl' ),
	'description'	=> __( 'This is the left top bar above the header.', 'tpl' ),
) );
genesis_register_sidebar( array(
	'id'		=> 'top-bar-right',
	'name'		=> __( 'Top Bar Right', 'tpl' ),
	'description'	=> __( 'This is the right top bar above the header.', 'tpl' ),
) );
genesis_register_sidebar( array(
	'id'          => 'after-header',
	'name'        => __( 'After Header', 'tpl' ),
	'description' => __( 'This is the after header section.', 'tpl' ),
) );
genesis_register_sidebar( array(
	'id'          => 'before-footer',
	'name'        => __( 'Before Footer', 'tpl' ),
	'description' => __( 'This is the before footer section.', 'tpl' ),
) );
...
add_action( 'genesis_before_footer', 'before_footer', 1);
