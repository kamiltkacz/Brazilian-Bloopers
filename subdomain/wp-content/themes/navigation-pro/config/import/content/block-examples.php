<?php
/**
 * Navigation Pro block examples page.
 *
...
<p class="has-text-align-center">Below are examples of column classes that are available in the block editor.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"align":"center"} -->
<h2 class="has-text-align-center">Blockquotes &amp; Pullquotes</h2>
<!-- /wp:heading -->

<!-- wp:pullquote {"customMainColor":"#ce3a0d","align":"wide","className":"has-background is-style-solid-color"} -->
<figure class="wp-block-pullquote alignwide has-background is-style-solid-color" style="background-color:#ce3a0d"><blockquote><p>Good design is as little as possible. Less, but better, because it concentrates on the essential aspects. Back to purity, back to simplicity. </p><cite> <br>Dieter Rams</cite></blockquote></figure>
<!-- /wp:pullquote -->

<!-- wp:heading {"align":"center"} -->
<h2 class="has-text-align-center">Buttons</h2>
<!-- /wp:heading -->
