 ...
 * Navigation Pro.
 *
 * This file defines helper functions used elsewhere in the Navigation Pro Theme.
 *
 * @package Navigation
 * @author  StudioPress
 ...
 */
function navigation_customizer_get_default_search_setting() {
	return 1;
}
 ...
 * @since 1.2.0
 */
function navigation_get_default_footer_logo() {
 ...
 */
function navigation_color_contrast( $color ) {
 ...
 */
function navigation_color_brightness( $color, $change ) {
 ...
 * @return string Hex code for the adjusted color brightness.
 */
function navigation_change_brightness( $color ) {
	...
	return ( $luminosity > 128 ) ? navigation_color_brightness( '#222222', 20 ) : navigation_color_brightness( '#ffffff', -50 );
